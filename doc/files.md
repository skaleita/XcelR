...
* xcelr.conf: contains configuration settings for xcelrd or xcelr-qt
* xcelrd.pid: stores the process id of xcelrd while running
...
* debug.log: contains debug information and general logging generated by xcelrd or xcelr-qt
