...
const char * const BITCOIN_CONF_FILENAME = "xcelr.conf";
const char * const BITCOIN_PID_FILENAME = "xcelrd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "XcelR";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/XcelR";
#else
    // Unix
    return pathRet / ".xcelr";
#endif
#endif
}
