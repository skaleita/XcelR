...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xcelr-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xcelr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xcelr transaction") + "\n" +
              "  xcelr-tx [options] -create [commands]   " + _("Create hex-encoded xcelr transaction") + "\n" +
              "\n";
